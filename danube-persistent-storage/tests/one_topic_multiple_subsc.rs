...
async fn test_multiple_subscriptions_independent_positions() {
    ...
    let mut reader1 = storage.create_reader(topic_name, StartPosition::Offset(0)).await.expect("create reader1");
    let mut reader2 = storage.create_reader(topic_name, StartPosition::Offset(5)).await.expect("create reader2");
    let mut reader3 = storage.create_reader(topic_name, StartPosition::Offset(10)).await.expect("create reader3");
...
async fn test_multiple_subscriptions_concurrent_reading() {
    ...
    let reader1_handle = {
        ...
        tokio::spawn(async move {
            let mut reader = storage1.create_reader(&topic_name, StartPosition::Offset(0)).await.expect("create reader1");
            barrier.wait().await;
    ...
    let reader2_handle = {
        ...
        let topic_name = topic_name.to_string();
        tokio::spawn(async move {
            let mut reader = storage2.create_reader(&topic_name, StartPosition::Offset(5)).await.expect("create reader2");
            barrier.wait().await;
    ...
    let reader3_handle = {
        ...
        let topic_name = topic_name.to_string();
        tokio::spawn(async move {
            let mut reader = storage3.create_reader(&topic_name, StartPosition::Latest).await.expect("create reader3");
            barrier.wait().await;
...
async fn test_multiple_subscriptions_with_cloud_handoff() {
    ...
    let mut reader1 = storage.create_reader(topic_name, StartPosition::Offset(0)).await.expect("create reader1");
    let mut reader2 = storage.create_reader(topic_name, StartPosition::Offset(20)).await.expect("create reader2");
    let mut reader3 = storage.create_reader(topic_name, StartPosition::Offset(45)).await.expect("create reader3");
...
async fn test_multiple_subscriptions_different_speeds() {
    ...
    let fast_reader_handle = {
        let topic_name = topic_name.to_string();
        tokio::spawn(async move {
            let mut reader = storage1.create_reader(&topic_name, StartPosition::Offset(0)).await.expect("create fast reader");
        let mut messages = Vec::new();
    ...
    let medium_reader_handle = {
        let topic_name = topic_name.to_string();
        tokio::spawn(async move {
            let mut reader = storage2.create_reader(&topic_name, StartPosition::Offset(0)).await.expect("create medium reader");
        let mut messages = Vec::new();
    ...
    let slow_reader_handle = {
        let topic_name = topic_name.to_string();
        tokio::spawn(async move {
            let mut reader = storage3.create_reader(&topic_name, StartPosition::Offset(0)).await.expect("create slow reader");
        let mut messages = Vec::new();
    ...
    let (fast_messages, medium_messages, slow_messages) = tokio::join!(
        fast_reader_handle,
        medium_reader_handle,
        slow_reader_handle
    );
...
async fn test_multiple_subscriptions_tail_reading() {
    ...
    let mut tail_reader1 = storage.create_reader(topic_name, StartPosition::Latest).await.expect("create tail reader1");
    let mut tail_reader2 = storage.create_reader(topic_name, StartPosition::Latest).await.expect("create tail reader2");
    let mut tail_reader3 = storage.create_reader(topic_name, StartPosition::Latest).await.expect("create tail reader3");
...
async fn test_multiple_subscriptions_mixed_start_positions() {
    ...
    let mut earliest_reader = storage.create_reader(topic_name, StartPosition::Offset(0)).await.expect("create earliest reader");
    let mut middle_reader = storage.create_reader(topic_name, StartPosition::Offset(15)).await.expect("create middle reader");
    let mut recent_reader = storage.create_reader(topic_name, StartPosition::Offset(35)).await.expect("create recent reader");
    let mut latest_reader = storage.create_reader(topic_name, StartPosition::Latest).await.expect("create latest reader");
