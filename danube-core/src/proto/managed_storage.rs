...
pub mod managed_storage_client {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    #[derive(Debug, Clone)]
    pub struct ManagedStorageClient<T> {
        inner: tonic::client::Grpc<T>,
    }
    impl ManagedStorageClient<tonic::transport::Channel> {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> ManagedStorageClient<InterceptedService<T, F>>
        where
        ...
        {
            ManagedStorageClient::new(InterceptedService::new(inner, interceptor))
        }
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/managed_storage.ManagedStorage/GetSegment",
            );
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/managed_storage.ManagedStorage/RemoveSegment",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("managed_storage.ManagedStorage", "RemoveSegment"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
pub mod managed_storage_server {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    #[derive(Debug)]
    pub struct ManagedStorageServer<T> {
        inner: Arc<T>,
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for ManagedStorageServer<T>
    where
        T: ManagedStorage,
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/managed_storage.ManagedStorage/GetSegment" => {
                    ...
                    for GetSegmentSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as ManagedStorage>::get_segment(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let fut = async move {
                        let method = GetSegmentSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                ...
                "/managed_storage.ManagedStorage/PutSegment" => {
                    ...
                    for PutSegmentSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ManagedStorage>::put_segment(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = PutSegmentSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/managed_storage.ManagedStorage/RemoveSegment" => {
                    #[allow(non_camel_case_types)]
                    struct RemoveSegmentSvc<T: ManagedStorage>(pub Arc<T>);
                    impl<
                        T: ManagedStorage,
                    ...
                    for RemoveSegmentSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ManagedStorage>::remove_segment(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T> Clone for ManagedStorageServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "managed_storage.ManagedStorage";
    impl<T> tonic::server::NamedService for ManagedStorageServer<T> {
