...
pub mod raft_transport_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> RaftTransportClient<InterceptedService<T, F>>
        where
        ...
        {
            RaftTransportClient::new(InterceptedService::new(inner, interceptor))
        }
        ...
        pub async fn append_entries(
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/danube.raft.RaftTransport/AppendEntries",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("danube.raft.RaftTransport", "AppendEntries"));
        ...
        pub async fn vote(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/danube.raft.RaftTransport/Vote",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("danube.raft.RaftTransport", "Vote"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn install_snapshot(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/danube.raft.RaftTransport/InstallSnapshot",
            );
            let mut req = request.into_request();
            req.extensions_mut()
...
pub mod raft_transport_server {
    ...
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with RaftTransportServer.
    #[async_trait]
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/danube.raft.RaftTransport/AppendEntries" => {
                    ...
                    struct AppendEntriesSvc<T: RaftTransport>(pub Arc<T>);
                    impl<
                        T: RaftTransport,
                    > tonic::server::UnaryService<super::RaftRequest>
                    for AppendEntriesSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as RaftTransport>::append_entries(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/danube.raft.RaftTransport/Vote" => {
                    #[allow(non_camel_case_types)]
                    struct VoteSvc<T: RaftTransport>(pub Arc<T>);
                    impl<
                        T: RaftTransport,
                    > tonic::server::UnaryService<super::RaftRequest> for VoteSvc<T> {
                        type Response = super::RaftReply;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RaftTransport>::vote(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/danube.raft.RaftTransport/InstallSnapshot" => {
                    #[allow(non_camel_case_types)]
                    struct InstallSnapshotSvc<T: RaftTransport>(pub Arc<T>);
                    impl<
                        T: RaftTransport,
                    > tonic::server::UnaryService<super::RaftRequest>
                    for InstallSnapshotSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RaftTransport>::install_snapshot(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
    ...
    pub const SERVICE_NAME: &str = "danube.raft.RaftTransport";
