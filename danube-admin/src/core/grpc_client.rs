...
impl AdminGrpcClient {
    ...
    pub async fn list_brokers(&self) -> Result<admin::BrokerListResponse> {
        let mut client =
            admin::broker_admin_client::BrokerAdminClient::new(self.channel.clone());
    ...
    pub async fn unload_broker(&self, req: admin::UnloadBrokerRequest) -> Result<admin::UnloadBrokerResponse> {
        let mut client =
            admin::broker_admin_client::BrokerAdminClient::new(self.channel.clone());
    ...
    pub async fn activate_broker(&self, req: admin::ActivateBrokerRequest) -> Result<admin::ActivateBrokerResponse> {
        let mut client =
            admin::broker_admin_client::BrokerAdminClient::new(self.channel.clone());
    ...
    pub async fn get_cluster_balance(&self, req: admin::ClusterBalanceRequest) -> Result<admin::ClusterBalanceResponse> {
        let mut client =
            admin::broker_admin_client::BrokerAdminClient::new(self.channel.clone());
    ...
    pub async fn trigger_rebalance(&self, req: admin::RebalanceRequest) -> Result<admin::RebalanceResponse> {
        let mut client =
            admin::broker_admin_client::BrokerAdminClient::new(self.channel.clone());
    ...
    pub async fn create_namespace(&self, req: admin::NamespaceRequest) -> Result<admin::NamespaceResponse> {
        let mut client =
    ...
    pub async fn delete_namespace(&self, req: admin::NamespaceRequest) -> Result<admin::NamespaceResponse> {
        let mut client =
            admin::namespace_admin_client::NamespaceAdminClient::new(self.channel.clone());
    ...
    pub async fn get_namespace_policies(&self, req: admin::NamespaceRequest) -> Result<admin::PolicyResponse> {
        let mut client =
            admin::namespace_admin_client::NamespaceAdminClient::new(self.channel.clone());
    ...
    pub async fn list_namespace_topics(&self, req: admin::NamespaceRequest) -> Result<admin::TopicInfoListResponse> {
        let mut client =
            admin::topic_admin_client::TopicAdminClient::new(self.channel.clone());
        let fut = async move { client.list_namespace_topics(req).await };
        self.execute_with_timeout(fut).await
    }

    pub async fn list_broker_topics(&self, req: admin::BrokerRequest) -> Result<admin::TopicInfoListResponse> {
        let mut client =
            admin::topic_admin_client::TopicAdminClient::new(self.channel.clone());
    ...
    pub async fn create_partitioned_topic(&self, req: admin::PartitionedTopicRequest) -> Result<admin::TopicResponse> {
        let mut client =
            admin::topic_admin_client::TopicAdminClient::new(self.channel.clone());
    ...
    pub async fn describe_topic(&self, req: admin::DescribeTopicRequest) -> Result<admin::DescribeTopicResponse> {
        let mut client =
            admin::topic_admin_client::TopicAdminClient::new(self.channel.clone());
    ...
    pub async fn list_subscriptions(&self, req: admin::TopicRequest) -> Result<admin::SubscriptionListResponse> {
        let mut client =
            admin::topic_admin_client::TopicAdminClient::new(self.channel.clone());
    ...
    pub async fn unsubscribe(&self, req: admin::SubscriptionRequest) -> Result<admin::SubscriptionResponse> {
        let mut client =
            admin::topic_admin_client::TopicAdminClient::new(self.channel.clone());
    ...
    pub async fn register_schema(&self, req: danube_schema::RegisterSchemaRequest) -> Result<danube_schema::RegisterSchemaResponse> {
        let mut client =
    ...
    pub async fn get_schema(&self, req: danube_schema::GetSchemaRequest) -> Result<danube_schema::GetSchemaResponse> {
        let mut client =
            danube_schema::schema_registry_client::SchemaRegistryClient::new(self.channel.clone());
    ...
    pub async fn get_latest_schema(&self, req: danube_schema::GetLatestSchemaRequest) -> Result<danube_schema::GetSchemaResponse> {
        let mut client =
            danube_schema::schema_registry_client::SchemaRegistryClient::new(self.channel.clone());
    ...
    pub async fn list_versions(&self, req: danube_schema::ListVersionsRequest) -> Result<danube_schema::ListVersionsResponse> {
        let mut client =
            danube_schema::schema_registry_client::SchemaRegistryClient::new(self.channel.clone());
    ...
    pub async fn check_compatibility(&self, req: danube_schema::CheckCompatibilityRequest) -> Result<danube_schema::CheckCompatibilityResponse> {
        let mut client =
            danube_schema::schema_registry_client::SchemaRegistryClient::new(self.channel.clone());
    ...
    pub async fn set_compatibility_mode(&self, req: danube_schema::SetCompatibilityModeRequest) -> Result<danube_schema::SetCompatibilityModeResponse> {
        let mut client =
            danube_schema::schema_registry_client::SchemaRegistryClient::new(self.channel.clone());
    ...
    pub async fn delete_schema_version(&self, req: danube_schema::DeleteSchemaVersionRequest) -> Result<danube_schema::DeleteSchemaVersionResponse> {
        let mut client =
            danube_schema::schema_registry_client::SchemaRegistryClient::new(self.channel.clone());
    ...
    pub async fn configure_topic_schema(&self, req: danube_schema::ConfigureTopicSchemaRequest) -> Result<danube_schema::ConfigureTopicSchemaResponse> {
        let mut client =
            danube_schema::schema_registry_client::SchemaRegistryClient::new(self.channel.clone());
    ...
    pub async fn get_topic_schema_config(&self, req: danube_schema::GetTopicSchemaConfigRequest) -> Result<danube_schema::GetTopicSchemaConfigResponse> {
        let mut client =
            danube_schema::schema_registry_client::SchemaRegistryClient::new(self.channel.clone());
    ...
    pub async fn update_topic_validation_policy(&self, req: danube_schema::UpdateTopicValidationPolicyRequest) -> Result<danube_schema::UpdateTopicValidationPolicyResponse> {
        let mut client =
            danube_schema::schema_registry_client::SchemaRegistryClient::new(self.channel.clone());
