...
pub async fn cluster_actions(
    ...
    let res = match action.as_str() {
        "unload" => {
            ...
            let request = danube_core::admin_proto::UnloadBrokerRequest {
        ...
        "activate" => {
            ...
            let request = danube_core::admin_proto::ActivateBrokerRequest {
                broker_id: req.broker_id.clone(),
                reason,
            };
            state
                .client
                .activate_broker(request)
                .await
