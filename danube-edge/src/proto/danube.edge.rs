...
pub struct RegisterEdgeRequest {
    /// Unique edge identifier, e.g. "edge1"
    #[prost(string, tag = "1")]
    pub edge_name: ::prost::alloc::string::String,
    /// JWT token (created by admin, scoped to namespace)
    #[prost(string, tag = "2")]
...
pub struct RegisterEdgeResponse {
    #[prost(bool, tag = "1")]
    pub success: bool,
    /// The namespace this edge is authorized for (e.g. "/edge1")
    #[prost(string, tag = "2")]
